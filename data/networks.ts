...
// See the official documentation on running a local Supersonic node: https://era.zksync.io/docs/tools/testing/
...
export const dockerizedNode: ZkSyncNetwork = {
  ...
  l1Network: {
    ...
    nativeCurrency: { name: "Ether 666", symbol: "ETH 7777", decimals: 18 },
    rpcUrls: {
...
const publicChains: ZkSyncNetwork[] = [
  {
    ...
    key: "mainnet",
    name: "Supersonic",
    rpcUrl: "https://mainnet.era.zksync.io", // TODO
    blockExplorerUrl: "https://era.zksync.network", // TODO
    blockExplorerApi: "https://block-explorer-api.mainnet.zksync.io", // TODO
    displaySettings: {
  ...
  },
  {
    ...
    key: "sepolia",
    name: "Supersonic Testnet",
    rpcUrl: "https://sepolia.era.zksync.dev", // TODO
    blockExplorerUrl: "https://sepolia-era.zksync.network", // TODO
    blockExplorerApi: "https://block-explorer-api.sepolia.zksync.dev", // TODO
    displaySettings: {
      showPartnerLinks: true,
    },
    l1Network: l1Networks.sepolia, // TODO
  },
  {
    id: 270,
    key: "stage",
